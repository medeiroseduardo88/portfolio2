...
.forEach(btn => {
    ...
    btn.addEventListener("click", () => {
        ...
        if(texto.includes("Sobre")){
            ...
            resposta.innerHTML =
            "Sou estudante de Ciência da Computação focado em Análise de Dados e Infraestrutura de TI.";
            ...
            resposta.innerHTML =
            "Estou desenvolvendo projetos com Power BI, Python e SQL voltados para análise de dados.";

        }

        else if(texto.includes("Habilidade")){

            resposta.innerHTML =
            "Tenho conhecimento em Power BI, SQL, Python, Excel, HTML, CSS e JavaScript.";
            ...
            resposta.innerHTML =
            "Você pode entrar em contato comigo pelo WhatsApp, LinkedIn ou formulário do site.";
